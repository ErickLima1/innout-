    ...
    <form action="#" method="post">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="text" id="name" placeholder="informe o nome" class="form-control
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="password" id="password" placeholder="informe a senha" class="form-control
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-6">
            <label for="confirm_password">Data de Desligamento</label>
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="checkbox" id="is_admin" class="form-control <?= $errors['is_admin'] ? 'is-invalid' : ''?>"
